...
casa.clientId = bin(randint(0,1024))
casa.produtor = bool(randint(0,1))
casa.consumo = bin(randint(0,1024))
casa.valorCompra = bin(randint(0,1024))
casa.producao = bin(randint(0,1024))
casa.valorVenda = bin(randint(0,1024))
